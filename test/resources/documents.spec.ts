...
describe('Documents', () => {
  ...
  describe('create', () => {
    it('should create a document', async () => {
      ...
      expect(client.post).toHaveBeenCalledWith('/open_api/knowledge/document/create', params);
  ...
  describe('update', () => {
    it('should update a document', async () => {
      ...
      expect(client.post).toHaveBeenCalledWith('/open_api/knowledge/document/update', params);
    });
  });
  ...
  describe('delete', () => {
    it('should delete documents', async () => {
      ...
      expect(client.post).toHaveBeenCalledWith('/open_api/knowledge/document/delete', params);
    });
  });
  ...
  describe('list', () => {
    it('should list documents', async () => {
      ...
      expect(client.get).toHaveBeenCalledWith('/open_api/knowledge/document/list', params);
