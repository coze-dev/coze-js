...
export class Audio extends APIResource {
   ...
   * @param params.response_format - Optional. Audio encoding format, supports "wav", "pcm", "ogg", "opus", "mp3", default is "mp3"
   * | 音频编码格式，支持 "wav", "pcm", "ogg", "opus", "mp3"，默认是 "mp3"
   * @param options - Request options
   * @returns Speech synthesis data
   */
  async speech(params: CreateSpeechReq, options?: RequestOptions) {
