...
const message2 = await client.conversations.messages.retrieve(conversation.id, message.id);
console.log('client.conversations.messages.retrieve', message2);

const updatedMessage = await client.conversations.messages.update(conversation.id, message.id, {
  content: '121212121',
  content_type: 'text',
  meta_data: {
    x: '1',
...
const deletedMessage = await client.conversations.messages.delete(conversation.id, updatedMessage.id);
